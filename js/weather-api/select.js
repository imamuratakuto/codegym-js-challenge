...
const weathers = {"Clear": "晴れ", "Clouds": "くもり", "Rain": "雨", "Snow": "雪", "Mist": "霧"};
const getUrl = () => {
        const index = select.selectedIndex;
        const selectCountry = select[index].value;
        const url =  "https://api.openweathermap.org/data/2.5/weather?q="+ selectCountry +"&units=metric&appid=4b5774e9f3d2a07b84f0f2f88e486224";
        fetch(url)
